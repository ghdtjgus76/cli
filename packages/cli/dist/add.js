...
var isInitialized = function isInitialized(cwd) {
  ...
  if (packageJsonPath) {
    var pandaCssPath = path.join(path.dirname(packageJsonPath), "node_modules", "@pandacss", "dev", "package.json");
    var styledSystemPath = path.join(path.dirname(packageJsonPath), "styled-system");
            ...
            return _regeneratorRuntime().wrap(function _loop$(_context) {
              while (1) switch (_context.prev = _context.next) {
                ...
                case 3:
                  ...
                  dir = path.join(options.path, "components", "designed-ui");
